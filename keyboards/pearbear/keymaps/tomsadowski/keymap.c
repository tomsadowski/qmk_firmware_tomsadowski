...
//    |___|   |XXX|   |XXX|   |___|   |___|    ------------
const uint16_t PROGMEM     caps_off_combo_l[] = {KC_C,    KC_H,     COMBO_END};
...
uint16_t get_combo_term(uint16_t index, combo_t* combo) {
    if (layer_state_is(GAME2D_LAYER) || layer_state_is(GAME3D_LAYER)) return 6;
    else return COMBO_TERM;
}
